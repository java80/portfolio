        ...
        <Grid item xs={12} style={{ padding: "0px" }}>
          ...
          <Grid container spacing={3} className={classes.mainContainer}>
            <Grid item xs={4} style={{ padding: "0px" }}>
              <a
                hover
                href="https://sad-einstein-72a4bc.netlify.app/"
                target="_blank"
              ...
              <span>Heroku</span>
              <br />
              <a href="https://github.com/java80/coursemanagement">
                <button className={classes.github}>Github</button>
              </a>
            </Grid>
            <Grid item xs={4} style={{ padding: "0px" }}>
              <a
                href="https://gracious-hodgkin-2b0838.netlify.app/Landing"
                target="_blank"
                rel="noopener noreferrer"
                className={classes.heading}
              >
                {" "}
                <h2>Dev-it-forward</h2>
              </a>
              <p>
                Creating an app for subject matter experts to connect to
                potential students for tutoring.
              </p>
              <h2>Tools Used</h2>
              ...
              <span>Netlify</span>
              <br />
              <a href="https://github.com/foremanlb/Dev-It-Forward">
                <button className={classes.github}>Github</button>
              </a>
            </Grid>
            <Grid item xs={4} style={{ padding: "0px" }}>
